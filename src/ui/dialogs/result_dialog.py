...
from PyQt6.QtWidgets import QDialog, QLayout, QVBoxLayout, QLabel, QFormLayout, QDialogButtonBox
...
class ResultDialog(QDialog):
    ...
    def setup_dialog(self, label_text: str, code_text: str, empty_text: str, comments_text: str, button_text: str,
                     setup: dict[str, dict[str, Any]]) -> None:
    ...
    def on_finished(self, results: dict[str, int]) -> None:
        try:
